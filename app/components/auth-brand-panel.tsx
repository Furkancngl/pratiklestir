...
export default function AuthBrandPanel() {
  return (
    <div className="relative hidden flex-col justify-between overflow-hidden border-r border-black/[.08] bg-white p-12 dark:border-white/[.06] dark:bg-[#0d0d12] md:flex">
      ...
      <div className="relative flex items-center gap-2.5 text-xl font-extrabold tracking-tight text-black opacity-0 [animation:auth-fade-up_.6s_ease_forwards] dark:text-white">
        <span className="h-2.5 w-2.5 rounded-[3px] bg-linear-to-br from-violet-400 to-pink-400" />
        Pratikleştir
      </div>

      <div className="relative max-w-[420px] opacity-0 [animation:auth-fade-up_.7s_ease_forwards_.15s]">
      ...
      <div className="relative flex items-center gap-3.5 rounded-2xl border border-black/[.08] bg-black/[.02] px-4.5 py-4 opacity-0 [animation:auth-fade-up_.6s_ease_forwards_.6s] dark:border-white/[.08] dark:bg-white/[.03]">
        <div className="flex">
